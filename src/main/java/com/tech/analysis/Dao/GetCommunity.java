...
//            return formatJsonString(getCommubityData(list,false));
...
//            return formatJsonString(getCommubityData(list,true));
//            return formatJsonString(getCommubityData(list));
        }
    }
        ...
        for (String string : list){
            ...
            while ( result.hasNext() )
            {
                ...
                try {
                    ...
                    int similar_times = Integer.parseInt(record.get("r_times").asString());
//                    System.out.println("////////////////////////////////////////////");
                    if (similar_times < 2) {
                        ++bad;
                        continue;
